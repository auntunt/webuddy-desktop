...
const appPath = path.join(packagePath, '.build', 'release', 'Webuddy Computer Use.app')
...
const bundleId = process.env.ORCA_COMPUTER_MACOS_BUNDLE_ID ?? 'cn.cloudwave.webuddy.computer-use'
const displayName = 'Webuddy Computer Use'
...
<dict>
  ...
  <string>Webuddy Computer Use needs Accessibility permission to read and interact with app interfaces when you ask Orca to use apps.</string>
  <key>NSScreenCaptureUsageDescription</key>
  <string>Webuddy Computer Use needs Screen Recording permission to capture app windows when you ask Orca to inspect your screen.</string>
</dict>
</plist>
`
}
