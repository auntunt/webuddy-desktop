...
describe('electron-builder config', () => {
  ...
  it('matches the Linux desktop entry to Electron window class', () => {
    expect(electronBuilderConfig.linux.desktop.entry.StartupWMClass).toBe('webuddy')
  })
  ...
  it('uses the release artifact set as local Linux targets without changing existing names', () => {
    ...
    expect(electronBuilderConfig.appImage.artifactName).toBe('webuddy-linux.${ext}')
    expect(electronBuilderConfig.deb.artifactName).toBe('webuddy_${version}_${arch}.${ext}')
