...
export const AMP_PLUGIN_MARKER = 'Managed by Webuddy. Do not edit; changes may be overwritten.'
...
export function getAmpPluginSource(): string {
  return [
    ...
    '  // Why: Amp sessions can outlive an Webuddy restart; the endpoint file is',
    ...
    '    })',
    '  } catch {',
    '    // Why: Webuddy status reporting must never affect the Amp run.',
    '  } finally {',
    ...
    '  // payload closures when Webuddy is down and each POST waits for timeout.',
