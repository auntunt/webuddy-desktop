...
import {
  ...
  shouldSuppressFirstRunEducation,
...
describe('shouldSuppressFirstRunEducation', () => {
  it('suppresses first-run education in packaged builds too', () => {
    expect(shouldSuppressFirstRunEducation({ env: {} })).toBe(true)
  })
