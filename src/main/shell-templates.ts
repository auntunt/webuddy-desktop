...
export const ZSH_WRAPPER_DIR_MARKER_CONTENT = `# Webuddy-generated zsh startup wrapper directory.
# Its presence is how Webuddy recognises its own wrapper dir instead of treating it
...
export const BASH_HISTFILE_RESTORE_BLOCK = `if [[ -n "\${ORCA_HISTFILE:-}" ]]; then
  ...
  # Why also when Webuddy injected nothing: /etc/zshrc derived this from Webuddy's
