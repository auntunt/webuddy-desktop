...
export const LINUX_PACKAGE_MARKER_UNUSABLE_MESSAGE =
  'Webuddy could not verify the installed Linux package format, so it will not install this update automatically. Download the update from the official release page and install it manually.'
export const LINUX_PACKAGE_EXTERNALLY_MANAGED_MESSAGE =
  'This copy of Webuddy is managed by your system package manager, so Webuddy cannot install updates itself. Update Webuddy through your distribution instead.'
export const LINUX_PACKAGE_MANUAL_INSTALL_MESSAGE =
  'Quit Webuddy before running the system package install command.'
