...
export function launchOrcaApp(): void {
  ...
  throw new RuntimeClientError(
    'runtime_open_failed',
    'Could not determine how to launch Webuddy. Start Webuddy manually and try again.'
  )
}
...
function resolveForegroundOrcaExecutable(): string {
  ...
  throw new RuntimeClientError(
    'runtime_serve_failed',
    'Could not determine how to start Webuddy server. Set ORCA_APP_EXECUTABLE to the Webuddy executable.'
  )
}
