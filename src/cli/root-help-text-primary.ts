export const ROOT_HELP_TEXT_PRIMARY = [
  ...
  '',
  'Startup:',
  '  open                      Launch Webuddy and wait for the runtime to be reachable',
  '  serve                     Start a headless Webuddy runtime server',
  '  status                    Show app/runtime/graph readiness',
  '',
  'Diagnostics:',
  '  diagnostics memory        Collect a memory snapshot for Webuddy and managed terminals',
  '',
  'Agent Discovery:',
  ...
  '  skills list               List version-matched skill guides bundled with this Webuddy CLI',
  '  skills get                Print a version-matched skill guide as Markdown',
  '  skills install            Install bundled Webuddy skills globally via the community skills CLI',
  '  skills update             Update already-installed Webuddy skills via the community skills CLI',
  '',
  'Hosts:',
  '  host list                 List targetable machines and how to name each one',
  '',
  'Environments:',
  '  environment add           Save a remote Webuddy runtime from a pairing code',
  '  environment list          List saved remote Webuddy runtimes',
  '  environment show          Show one saved remote Webuddy runtime',
  '  environment rm            Remove a saved remote Webuddy runtime',
  '',
  'Environment Recipes:',
  '  vm recipe doctor          Validate a per-workspace environment recipe',
  '',
  'Automations:',
  '  automations list          List scheduled Webuddy automations',
  '  automations show          Show one Webuddy automation',
  '  automations create        Create a scheduled Webuddy automation',
  '  automations edit          Edit an Webuddy automation',
  '  automations remove        Remove an Webuddy automation and its run history',
  '  automations run           Run an Webuddy automation now',
  '  automations runs          List automation run history',
  '',
  'Projects:',
  '  project list              List durable projects known to Webuddy',
  ...
  '',
  'Repos:',
  '  repo list                 List repos registered in Webuddy',
  '  repo add                  Add a project to Webuddy by filesystem path',
  ...
  '',
  'Worktrees:',
  '  worktree list             List Webuddy-managed worktrees',
  '  worktree show             Show one worktree',
  '  worktree current          Show the Webuddy-managed worktree for the current directory',
  '  worktree create           Create a new Webuddy-managed worktree',
  '  worktree set              Update Webuddy metadata for a worktree',
  '  worktree rm               Remove a worktree from Webuddy and git',
  '  worktree ps               Show a compact orchestration summary across worktrees',
  '',
  'Files:',
  '  file open                 Open a workspace file in the Webuddy editor',
  '  file diff                 Open a workspace file diff in the Webuddy editor',
  '  file open-changed         Open all git-changed files for a workspace',
  '',
  'Terminals:',
  '  terminal list             List live Webuddy-managed terminals',
  ...
  '  emulator list             List available/running emulators (Webuddy-managed + raw serve-sim)',
