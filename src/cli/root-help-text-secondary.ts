export const ROOT_HELP_TEXT_SECONDARY = [
  ...
  '  --pairing-code <code>      Connect to a remote Webuddy runtime using an webuddy://pair?... code',
  '  --environment <selector>   Connect using a saved environment id or name',
  '  --help                    Show this help message',
  '',
  'Behavior:',
  '  Most commands require a running Webuddy runtime. If Webuddy is not open yet, run `orca open` first.',
