...
export const FLAG_HELP_TEXT: Record<string, string> = {
  ...
  comment: '--comment <text>       Comment stored in Webuddy metadata',
  ...
  activate: '--activate             Reveal the new worktree in the Webuddy app',
  ...
  'display-name': '--display-name <name>  Override the Webuddy display name',
  ...
  focus: '--focus                Reveal the created terminal session in Webuddy',
  ...
  current: '--current              Use the current Webuddy worktree linked Linear issue',
