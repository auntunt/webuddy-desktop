      ...
      .catch((error: unknown) => {
        ...
        if (error instanceof RuntimeClientError && error.code === 'method_not_found') {
          throw new RuntimeClientError(
            ...
            'This Webuddy server cannot look up orchestration mutation requests yet. Update Webuddy on the server, or inspect the Dispatch directly with orchestration worker-show.'
          )
        }
        throw error
      })
