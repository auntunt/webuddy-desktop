...
export const AUTOMATION_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    summary: 'List scheduled Webuddy automations',
  ...
  },
  {
    ...
    summary: 'Show one Webuddy automation',
  ...
  },
  {
    ...
    summary: 'Create a scheduled Webuddy automation',
    usage:
    ...
    notes: [
      ...
      'When --repo is omitted, the CLI uses the enclosing Webuddy worktree when one can be resolved from cwd.',
  ...
  },
  {
    ...
    summary: 'Edit an Webuddy automation',
  ...
  },
  {
    ...
    destructive: true,
    summary: 'Remove an Webuddy automation and its run history',
  ...
  },
  {
    ...
    summary: 'Run an Webuddy automation now',
