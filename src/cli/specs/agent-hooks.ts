...
export const AGENT_HOOK_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    summary: 'Repair Webuddy-managed Codex hook trust before a shell launch',
    usage: 'orca agent hooks prepare-codex',
    allowedFlags: [...GLOBAL_FLAGS]
  },
  {
    path: ['agent', 'hooks', 'status'],
    summary: 'Show whether Webuddy-managed agent status hooks are enabled',
  ...
  },
  {
    ...
    summary: 'Disable Webuddy-managed agent status hooks and remove local hook entries',
  ...
  {
    path: ['agent', 'hooks', 'on'],
    summary: 'Enable Webuddy-managed agent status hooks',
