...
export const ARTIFACT_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    summary: 'Share an HTML or Markdown file with your Webuddy account',
  ...
  },
  {
    ...
    summary: 'Update a file previously shared from this Webuddy profile',
  ...
  {
    path: ['artifacts', 'list'],
    summary: 'List artifacts owned by the signed-in Webuddy account',
  ...
  },
  {
    ...
    destructive: true,
    summary: 'Delete an artifact owned by the signed-in Webuddy account',
