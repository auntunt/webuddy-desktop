...
const SessionCanvasPage = lazy(() => import('../components/session-canvas/SessionCanvasPage'))
...
function ActivePage({ layout }: { layout: AppChromeLayout }): React.JSX.Element {
  ...
  return (
    <>
      ...
      {activeView === 'session-canvas' ? <SessionCanvasPage /> : null}
                ...
                <div className="flex flex-1 min-w-0 min-h-0 flex-col">
                  ...
                  <Suspense fallback={null}>
                    <RecoverableRenderErrorBoundary
                      ...
                      description={translate(
                        'auto.App.03a14f6b5b',
                        'Retry the page or navigate to another Webuddy surface.'
                      )}
                    >
