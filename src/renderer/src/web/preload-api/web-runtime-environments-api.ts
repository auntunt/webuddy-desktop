...
> {
  return {
    ...
    addFromPairingCode: async ({ name, pairingCode }) => {
      ...
      if (!offer) {
        throw new Error('Invalid Webuddy pairing code.')
      }
      ...
      try {
        ...
        return {
          ...
          message: translate(
            ...
            'Cannot reach Webuddy at {{endpoint}}.',
      ...
      try {
        ...
        return {
          ...
          message: translate(
            ...
            'Webuddy verified the host but could not save it. Check browser storage and try again.'
          )
        }
      }
      manuallyDisconnectedEnvironmentIds.clear()
