          ...
          <p className="text-sm text-muted-foreground">
            {email
              ? translate(
                  ...
                  'Sign in again as {{value0}} to restore Artifact sharing, Webuddy Relay, and skill sharing.',
                  { value0: email }
                )
              : translate(
                  'auto.components.UnexpectedSignoutCard.5a1c8d3e6f',
                  'Sign in again to restore Artifact sharing, Webuddy Relay, and skill sharing.'
                )}
          </p>
            ...
            <CollapsibleContent className="space-y-3 pt-2.5">
              <FeatureRow
                ...
                description={translate(
                  ...
                  'Publish HTML and Markdown files and manage every shared link from Webuddy.'
                )}
              />
              <FeatureRow
                icon={Smartphone}
                title={translate(
                  'auto.components.UnexpectedSignoutCard.6e3f1a9c5b',
                  'Webuddy Relay'
                )}
                description={translate(
