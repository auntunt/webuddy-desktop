  ...
  agent: {
    ...
    get subtitle() {
      return translate(
        ...
        "Webuddy works with every CLI agent. Choose the one you'll reach for most. Switch any time."
      )
    }
  },
  theme: {
  ...
  notifications: {
    ...
    get subtitle() {
      return translate(
        ...
        'Webuddy will notify you when agents are done or need help.'
      )
    }
  },
  integrations: {
        ...
        >
          <div className="relative flex h-full min-h-0 flex-col px-6 pb-6 pt-8 sm:px-8 sm:pb-8 sm:pt-9">
            <div className="flex items-center gap-3 text-base font-semibold tracking-tight">
              ...
              />
              <span>
                {translate('auto.components.onboarding.OnboardingFlow.a249f81538', 'Webuddy')}
              </span>
            </div>
