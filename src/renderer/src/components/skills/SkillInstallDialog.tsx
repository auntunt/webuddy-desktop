    ...
    if (!shareId) {
      setError(
        translate(
          ...
          'Enter an Webuddy skill share link.'
        )
      )
      return
    }
    ...
    try {
        ...
        setError(
          operation.status === 'reconnect-required'
            ? translate(
                ...
                'Reconnect your Webuddy account before installing.'
              )
            : operation.message
        )
        return
      ...
      setError(
        translate(
          ...
          'Installation failed before Webuddy could verify the requested version.'
        )
      )
    } finally {
