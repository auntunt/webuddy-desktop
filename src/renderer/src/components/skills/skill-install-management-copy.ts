...
export function skillInstallManagementCopy() {
  return {
    title: translate(
      ...
      'Installed by Webuddy'
    ),
    description: translate(
      'auto.components.skills.SkillInstallManagementDialog.3677ae58e7',
      'Skills Webuddy installed from a link. Reinstall, go back to an earlier version, or remove them.'
    ),
    ...
    noInstalls: translate(
      ...
      'Webuddy has not installed any skills on this machine yet.'
    ),
