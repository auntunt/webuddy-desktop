...
describe('parseSkillShareId', () => {
  it('accepts durable Orca links and bare identifiers', () => {
    ...
    expect(parseSkillShareId('https://app.cloudwaveai.cn/skills/share/share_123')).toBe('share_123')
    expect(parseSkillShareId('https://share.cloudwaveai.cn/skills/share/share_123/')).toBe(
      'share_123'
    )
    expect(parseSkillShareId('webuddy://skills/share/share_123')).toBe('share_123')
  })
  ...
  it('rejects attacker origins and lookalike paths', () => {
    ...
    expect(parseSkillShareId('https://app.cloudwaveai.cn/skills/share/share_123/more')).toBeNull()
