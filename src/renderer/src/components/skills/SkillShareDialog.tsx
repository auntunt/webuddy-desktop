...
function operationError(status: string): string {
  return status === 'reconnect-required'
    ? translate(
        ...
        'Reconnect your Webuddy account before sharing.'
      )
    : translate(
        'auto.components.skills.SkillShareDialog.unconfigured',
        'Connect an Webuddy Cloud account before sharing.'
      )
}
    ...
    try {
      ...
      setError(
        translate(
          ...
          'Webuddy could not send the cancellation request. The upload may still finish.'
        )
      )
    }
  }
