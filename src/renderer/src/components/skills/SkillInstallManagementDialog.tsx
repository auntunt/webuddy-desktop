    ...
    try {
      ...
      setError(
        translate(
          ...
          'Webuddy could not inspect managed installs on this machine.'
        )
      )
    } finally {
      if (generation === loadGeneration.current) {
        ...
        setError(
          operation.status === 'reconnect-required'
            ? translate(
                ...
                'Reconnect your Webuddy account to load version history.'
              )
            : operation.message
        )
        return
    ...
    try {
          ...
          setError(
            operation.status === 'reconnect-required'
              ? translate(
                  ...
                  'Reconnect your Webuddy account before changing versions.'
                )
              : operation.message
          )
          return
      ...
      setError(
        translate(
          ...
          'Webuddy could not verify the requested version.'
        )
      )
    } finally {
    ...
    try {
      ...
      setError(
        translate(
          ...
          'Webuddy could not safely remove this skill.'
        )
      )
    } finally {
      setBusy(false)
