...
const DOCS_URL = 'https://cloudwaveai.cn/docs'
const CHANGELOG_URL = 'https://cloudwaveai.cn/changelog'
const GITHUB_URL = 'https://cloudwaveai.cn'
const DISCORD_URL = 'https://cloudwaveai.cn'
const X_URL = 'https://cloudwaveai.cn'
...
export function SidebarSettingsHelpMenu(): React.JSX.Element {
  ...
  const handleRestartOrca = (): void => {
    ...
    toast.info(
      translate('auto.components.sidebar.SidebarSettingsHelpMenu.5161eef55d', 'Restarting Webuddy…')
    )
