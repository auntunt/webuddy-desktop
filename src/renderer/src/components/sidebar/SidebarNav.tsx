...
export function shouldShowMobileButton(
  _settings?: Partial<Pick<GlobalSettings, 'showMobileButton'>> | null
): boolean {
  // Why always false: the mobile companion is out of scope for now, so the
  // sidebar entry, its onboarding badge and its nudge are all suppressed. The
  // setting itself is left intact so an existing profile is not rewritten.
  return false
}
            ...
            >
              ...
              >
                ...
                <span className="min-w-0 flex-1 truncate">
                  {translate('auto.components.sidebar.SidebarNav.1b5c41caee', 'Webuddy Mobile')}
                </span>
