...
export function LinearApiKeyDialog({
  ...
  const resolvedDescription =
    ...
    (workspace
      ...
      : 'Paste a Personal API key for the Linear workspace you want Webuddy to use. If that workspace is already connected, Webuddy replaces its stored key.')
  const storageCopy =
          ...
          <div className="space-y-2 text-xs leading-relaxed text-muted-foreground">
            ...
            <p>
              {translate(
                ...
                'Prefer full access when Webuddy should show every team the account can access in that workspace. Restricted keys only expose permitted teams, and private teams require the key owner to have access.'
              )}
            </p>
            <p>
              {translate(
