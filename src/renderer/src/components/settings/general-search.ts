...
export const getGeneralWorkspaceSearchEntries = createLocalizedCatalog(() => [
  ...
  },
  {
    ...
    description: translate(
      ...
      'Choose whether worktrees created outside Webuddy appear by default.'
    ),
    keywords: [
...
export const getGeneralCliSearchEntries = createLocalizedCatalog(() => [
  {
    title: translate('auto.components.settings.general.search.327e3fa70d', 'Webuddy CLI'),
    description: translate(
      'auto.components.settings.general.search.ca529079bf',
      'Register or remove the Webuddy CLI command.'
    ),
    keywords: [
  ...
  },
  {
    ...
    description: translate(
      ...
      'Install the Webuddy skill so agents know to use the Webuddy CLI.'
    ),
    keywords: [
...
export const getGeneralUpdateSearchEntries = createLocalizedCatalog(() => [
  {
    ...
    description: translate(
      ...
      'Check for app updates and install a newer Webuddy version.'
    ),
    keywords: [
