              ...
              <p className="text-xs text-muted-foreground">
                {tokenFresh
                  ? translate(
                      ...
                      'Signed in. Webuddy reads the Grok CLI session stored on disk.'
                    )
                  : translate(
                      'auto.components.settings.GrokAccountsSection.f08c41de73',
                      'Session expired — run grok on the computer running Webuddy and wait for it to start. If prompted, complete sign-in, then click Refresh usage. No chat message is needed.'
                    )}
              </p>
            </>
          ) : (
