      ...
      : [
          {
            ...
            description: isWebClient
              ? translate(
                  ...
                  'Open Settings → Artifacts in the Webuddy desktop app on the host device and enable publishing.'
                )
              : translate(
        ...
        <section className="flex flex-wrap items-center gap-4 py-5">
          <div className="min-w-0 flex-1 space-y-1">
            ...
            <p className="text-xs leading-relaxed text-muted-foreground">
              {translate(
                ...
                'Use your Webuddy account to upload artifacts and manage their public links.'
              )}
            </p>
          </div>
          <Button
          ...
          >
            {authStatus?.state === 'reconnect-required'
              ...
              : translate('auto.components.settings.artifacts.signIn', 'Sign in to Webuddy')}
          </Button>
        </section>
      ) : null}
