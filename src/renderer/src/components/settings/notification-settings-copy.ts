...
export function getSystemNotificationSettingsCopy(
  ...
  if (platform === 'darwin') {
    return {
      ...
      failureDescription: 'Enable Allow notifications for Webuddy in System Settings.'
    }
  }
  ...
  if (platform === 'win32') {
    return {
      ...
      failureDescription: 'Enable notifications for Webuddy in Windows Settings.'
    }
  }
      ...
      toast.message(
        ...
        ),
        {
          description: translate(
            ...
            'If no macOS banner appeared, enable Allow notifications for Webuddy.'
          ),
          action: {
            label: translate(
      ...
      toast.error(
        ...
        ),
        {
          description: translate(
            ...
            'Check your desktop notification settings for Webuddy.'
          )
        }
      )
    }
