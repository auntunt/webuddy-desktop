  ...
  return (
    <SettingsSection
      ...
      description={translate(
        ...
        'Finish the core workflows that make Webuddy useful for parallel agent work.'
      )}
  ...
  return (
    <SettingsSection
      ...
      description={translate(
        ...
        'Search everything your agents have said and done, on this computer and on any paired Webuddy server.'
      )}
