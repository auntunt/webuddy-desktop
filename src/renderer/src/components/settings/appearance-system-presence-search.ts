...
const getSystemTrayEntryCatalog = createLocalizedCatalog((): SettingsSearchEntry[] => [
  {
    ...
    description: translate(
      ...
      'When enabled, closing the window keeps Webuddy running in the system tray instead of quitting.'
    ),
    keywords: [
...
const getMenuBarIconEntryCatalog = createLocalizedCatalog((): SettingsSearchEntry[] => [
  {
    ...
    description: translate(
      ...
      'Keep an Webuddy shortcut and activity indicator in the macOS menu bar.'
    ),
    keywords: [
