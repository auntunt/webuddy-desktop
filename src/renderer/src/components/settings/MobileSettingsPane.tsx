...
const ORCA_ANDROID_APK_URL = 'https://cloudwaveai.cn/download/webuddy-android.apk'
    ...
    <div className="space-y-4">
        ...
        <div className="space-y-2 text-xs text-muted-foreground">
          <p>
            {translate(
              ...
              'Install Webuddy Mobile from the'
            )}{' '}
            <button
              type="button"
      ...
      <SearchableSetting
        title={translate(
          ...
          'Show Webuddy Mobile Button'
        )}
        description={translate(
          'auto.components.settings.MobileSettingsPane.682293cadf',
          'Show the Webuddy Mobile button at the top of the left sidebar.'
        )}
      ...
      >
        ...
        <SettingsSwitchRow
          ...
          description={translate(
            ...
            'Show the Webuddy Mobile shortcut in the sidebar.'
          )}
