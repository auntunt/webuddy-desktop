        ...
        <div className="space-y-0.5">
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'When an agent starts working in a new workspace, Webuddy renames its auto-generated branch (e.g.'
            )}{' '}
            <code>
              {translate(
            ...
            {translate(
              ...
              ') to a short name summarizing the task. Only branches Webuddy named itself are renamed, and never after they have been pushed.'
            )}
          </p>
        </div>
        <Switch
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  {translate(
                    ...
                    '. Webuddy generates only the final segment, like'
                  )}{' '}
                  <code className="font-mono">
                    {translate(
