  ...
  return [
    ...
    },
    {
      ...
      description: translate(
        ...
        'Coordinate multiple coding agents through Webuddy.'
      ),
      icon: Network,
      ...
      ? [
          {
            ...
            description: translate(
              ...
              'How Linear works in Webuddy, setup checklist, agent skill, and example prompts.'
            ),
            icon: LinearIcon,
  ...
  return [
    ...(showDesktopOnlySettings
      ? [
          {
            id: 'orca-account',
            title: translate('auto.components.settings.orcaAccount.title', 'Webuddy Account'),
            description: translate(
              'auto.components.settings.orcaAccount.description',
              'Share work instantly and reach your desktop from Webuddy Mobile wherever you are.'
            ),
      ...
      : []),
    {
      ...
      description: translate(
        ...
        'Finish the onboarding checklist for core Webuddy workflows.'
      ),
