  ...
  toast.error(
    ...
    ),
    {
      ...
      description: translate(
        ...
        'Workspaces are unavailable on a mobile-scope pairing. Reconnect using the browser access link from Settings → Runtime Environments → Share this Webuddy server.'
      )
    }
  )
  return true
