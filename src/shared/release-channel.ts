...
export const HOURLY_RELEASE_REPO = 'cloudwave/webuddy-hourly'
export const DAILY_RELEASE_REPO = 'cloudwave/webuddy-daily'
export const ADHOC_RELEASE_REPO = 'cloudwave/webuddy-adhoc'
export const MAIN_RELEASE_REPO = 'cloudwave/webuddy'
