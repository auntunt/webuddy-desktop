...
export const FEATURE_WALL_WORKFLOWS: readonly FeatureWallWorkflow[] = [
  {
    ...
    lede: 'Webuddy splits each task into an isolated workspace so agents can run in parallel.',
  ...
  },
  {
    ...
    title: 'Agents',
    meta: 'Agents · Usage · Webuddy CLI',
    lede: 'Run several agents at once, track their progress, and let automation drive Webuddy when it helps.',
  ...
  },
  {
    ...
    lede: 'Bring your terminal setup into Webuddy, then split panes to keep servers, tests, logs, and agents running side by side.',
