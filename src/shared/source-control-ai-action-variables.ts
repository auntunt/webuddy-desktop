...
export const SOURCE_CONTROL_ACTION_VARIABLE_INFO = {
  basePrompt: {
    description:
      'Webuddy’s built-in prompt for this action, including the context Webuddy knows how to gather safely.',
    example:
  ...
  firstPrompt: {
    description: 'The first user request that created the Webuddy workspace.',
    example: 'Fix CI and commit the result'
  },
  assistantMessage: {
    description: 'The initial agent response, when Webuddy has one available.',
