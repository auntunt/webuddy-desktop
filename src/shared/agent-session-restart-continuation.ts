...
export const AGENT_SESSION_RESTART_CONTINUATION_MESSAGE =
  "Webuddy restarted, so your previous reply was cut off partway through. Before continuing, check whether your most recent action completed — don't repeat it if it did. Then carry on."
...
export const AGENT_SESSION_RESTART_CONTINUATION_NOTE =
  'Webuddy asked this agent to continue after a restart. Your own prompt was not re-sent.'
