...
export function createMobileRelayPairingFixtures(now: number): PairingFixture[] {
  ...
  const relay = {
    v: 1 as const,
    directorUrl: 'https://relay.cloudwaveai.cn',
    cellUrl: 'https://relay-c1.cloudwaveai.cn',
    assignmentEpoch: 7,
  ...
  return [
    ...
    },
    {
      ...
      payload: {
        ...directOffer,
        relay: { ...relay, directorUrl: 'https://relay.cloudwaveai.cn/' }
      },
      expected: null
    },
    {
      name: 'non-HTTPS cell origin is invalid',
      payload: { ...directOffer, relay: { ...relay, cellUrl: 'http://relay-c1.cloudwaveai.cn' } },
      expected: null
    },
    {
