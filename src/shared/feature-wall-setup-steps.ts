...
export const FEATURE_WALL_SETUP_STEPS: readonly FeatureWallSetupStep[] = [
  ...
  {
    id: 'browser',
    name: "Use Webuddy's browser",
    subtitle: "Use Webuddy's browser",
    description:
      'Browse your web app without leaving Webuddy. Grab any element and send its exact source and styles to an agent with one click.'
  },
  {
    id: 'notifications',
  ...
  },
  {
    ...
    name: 'Enable Webuddy CLI',
    subtitle: 'Enable Webuddy CLI',
    description:
      'Register the Webuddy shell command and install agent skills for browser, computer, and orchestration workflows.'
  },
  {
    id: 'task-sources',
  ...
  },
  {
    ...
    description:
      'Bring your key repos into Webuddy so you can start agent work without hunting for folders.'
  }
] as const
