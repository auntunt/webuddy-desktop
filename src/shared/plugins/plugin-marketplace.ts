...
export const PLUGIN_MARKETPLACE_FILENAME = 'webuddy-marketplace.json'
export const PLUGIN_MARKETPLACE_ENTRY_LIMIT = 2_048
export const PLUGIN_MARKETPLACE_CATEGORY_LIMIT = 16

export const OFFICIAL_PLUGIN_PUBLISHER = 'cloudwave'
export const OFFICIAL_PLUGIN_ID_PREFIX = 'webuddy-'
export const OFFICIAL_MARKETPLACE_OWNER = 'cloudwave'
export const OFFICIAL_MARKETPLACE_REPOSITORY = 'webuddy-plugins'
...
export const OFFICIAL_MARKETPLACE_GIT_SOURCE: PluginMarketplaceGitSource = {
  kind: 'git',
  url: 'https://github.com/cloudwave/webuddy-plugins.git',
  ref: 'main'
}
